...
public class MutualFundAccount {
	...
	public MutualFundAccount(MutualFund mf) {
		MutualFund temp = new MutualFund(mf.getFundName(), mf.getTicker(),
				mf.getPricePerShare(), mf.getTradingFee());
		this.mf = temp;
		this.numShares = 0.00;
	}
	...
	public MutualFundAccount(MutualFund mf, double numShares) {
		MutualFund temp  = new MutualFund(mf.getFundName(), mf.getTicker(), mf.getPricePerShare(), mf.getTradingFee());
		this.mf = temp;
		this.numShares = numShares;
	}
